...
names(week1_sleep) <- c("Sunday", "Monday", "Tuesday", "Wednesday", "Thursday", "Friday")
names(week2_sleep) <- c("Sunday", "Monday", "Tuesday", "Wednesday", "Thursday", "Friday")

## Display the amount of sleep on Tuesday of week 1 by selecting the variable name
week1_sleep[c("Tuesday")]
...
rownames(assignments) <- c("Assignment 1", "Assignment 2", "Assignment 3")
colnames(students) <- c("Florinda Baird", "Jinny Foss", "Lou Purvis", "Nola Maloney")
